...
@Controller('/v1/users')
export class ListedSparePartByUserController {
  constructor(
  ...
  @Get('/user/:userId/listedSpareParts')
  async findManyUserId(
    ...
    const items = await this.listedSparePartDomainFacade.findManyByUser(
      parent,
      queryOptions,
    )
  ...
  @Post('/user/:userId/listedSpareParts')
