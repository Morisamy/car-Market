...
@Controller('/v1/users')
export class PurchaseHistoryByUserController {
  constructor(
  ...
  @Get('/user/:userId/purchaseHistorys')
  async findManyUserId(
    ...
    const items = await this.purchaseHistoryDomainFacade.findManyByUser(
      parent,
      queryOptions,
    )
  ...
  @Post('/user/:userId/purchaseHistorys')
